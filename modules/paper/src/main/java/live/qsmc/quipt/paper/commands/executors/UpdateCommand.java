                            ...
                            .executes(context -> {
                                ...
                                new Thread(() -> {
                                    try {
                                        ...
                                        source.getSender().sendMessage("Downloaded " + artifact + (finalDeleted > 0 ? " and removed " + finalDeleted + " old version(s). Restart to apply." : ". Restart to apply."));
                                    } catch (Exception e) {
                                        source.getSender().sendMessage("Update failed: " + e.getMessage());
                                    }
                                }).start();
