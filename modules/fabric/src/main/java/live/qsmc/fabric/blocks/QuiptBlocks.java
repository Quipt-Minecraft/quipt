package live.qsmc.fabric.blocks;

import live.qsmc.core2.data.annotations.Nullable;
import live.qsmc.fabric.blocks.abstracts.QuiptBlock;
import live.qsmc.fabric.blocks.abstracts.QuiptBlockWithEntity;
...
public class QuiptBlocks {
    ...
    public static final live.qsmc.core.data.registries.Registry<QuiptBlock> BLOCKS = live.qsmc.core.data.registries.Registries.register("blocks", ()->null);
    public static final live.qsmc.core.data.registries.Registry<BlockEntityType<? extends BlockEntity>> ENTITY_TYPES = live.qsmc.core.data.registries.Registries.register("block_entity", ()->null);
    public static final live.qsmc.core.data.registries.Registry<BlockProperty<?>> BLOCK_PROPERTIES = live.qsmc.core.data.registries.Registries.register("block_properties", ()->null);
