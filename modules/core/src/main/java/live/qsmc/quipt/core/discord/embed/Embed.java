package live.qsmc.quipt.core.discord.embed;
...
public class Embed implements JsonSerializable {
    ...
    public static class Builder {
        ...
        public Builder field(Field field) {
            return field(field.name, field.value, field.inline);
        }

        public Embed build() {
            return new Embed(data.toString());
        }
    }
}
